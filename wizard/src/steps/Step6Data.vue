<script setup>
const phase2Items = [
  'Chart library: ECharts (default) / Chart.js / Unovis / Recharts — wrapper stays lib-agnostic',
  'Tables: server-side pagination, bulk actions, row selection, export',
  'Real-time: none / polling / websockets (Echo + Reverb)',
]
</script>
  ...
  <div class="max-w-2xl">
    ...
    >
      ...
      <ul class="mt-3 space-y-2 text-sm">
        <li v-for="item in phase2Items" :key="item" class="flex items-start gap-2">
          <span
